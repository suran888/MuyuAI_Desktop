    ...
    >
      ...
      >
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
          <g id="Frame">
            <path
              d={svgPaths.p1fe60100}
              fill={isActive ? "#C17FFF" : "white"}
              id="Vector"
            />
          </g>
        </svg>
      ...
      {showTooltip && (
        <div className="absolute right-[32px] top-[-4px] z-[99999]">
          ...
          <p className="absolute font-['PingFang_SC:Medium',sans-serif] h-[20px] leading-[normal] right-[17px] not-italic text-[14px] text-white top-[5px] whitespace-nowrap">截屏提问</p>
        </div>
      )}
    </div>
  );
